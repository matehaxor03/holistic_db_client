...
func TestCanParseFloat64PositiveLowBoundary(t *testing.T) {
	json := ParseJSONSuccessfully(t, "{\"key\":" + fmt.Sprintf("%f", (math.MaxFloat32 * 10)) +"}")
...
func TestCanParseFloat64NegativeLowBoundary(t *testing.T) {
	json := ParseJSONSuccessfully(t, "{\"key\":" + fmt.Sprintf("%f", ((-1 * math.MaxFloat32 * 10))) +"}")
...
func TestCanParseFloat64MultiplePositiveLowBoundary(t *testing.T) {
	json := ParseJSONSuccessfully(t, "{\"key\":341234567890000000000000000000000000000.01,\"key2\":349876543210000000000000000000000000000.01}")
...
func TestCanParseFloat64PositiveHighBoundary(t *testing.T) {
	json := ParseJSONSuccessfully(t, "{\"key\":.00}")
...
func TestCanParseFloat64MultipleNegativeHighBoundary(t *testing.T) {
	json := ParseJSONSuccessfully(t, "{\"key\":-.98,\"key2\":-.99}")
