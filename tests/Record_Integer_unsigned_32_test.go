...
func TestRecordCanCreateRecordWithIntegerUnsigned32Column(t *testing.T) {
	...
	value, value_errors := record.GetUInt32(GetTestTableIntegerUnsigned32ColumnName())
	if value_errors != nil {
...
func TestRecordCanUpdateRecordWithIntegerUnsigned32Colum(t *testing.T) {
	...
	if record_errors != nil {
		...
		set_errors := record.SetUInt32(GetTestTableIntegerUnsigned32ColumnName(), &update_value)
		if set_errors != nil {
